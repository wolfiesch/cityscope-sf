...
import { PRESET_ICON_SIZE } from "../types";
...
const PRESETS: Preset[] = [
  {
    ...
    icon: <Flame size={PRESET_ICON_SIZE} />,
  ...
  },
  {
    ...
    icon: <Siren size={PRESET_ICON_SIZE} />,
  ...
  },
  {
    ...
    icon: <ClipboardList size={PRESET_ICON_SIZE} />,
  ...
  },
  {
    ...
    icon: <Swords size={PRESET_ICON_SIZE} />,
